...
if (!/^http/.test(website)) {
  ...
  setWebsiteError("");
    ...
    axios.post("http://localhost:3005/users", data).then(navigate("/"));
  }
  ...
  return (
    <div className="w-screen h-full flex flex-col justify-center items-center mt-5">
      <h2 className="text-2xl font-bold"><lord-icon 
                    src="https://cdn.lordicon.com/mrdiiocb.json"
                    trigger="hover"
                    colors="primary:#16a9c7"
               >
                </lord-icon>ADD USER</h2>
      <form className="w-[50%] h-full flex flex-col mt-2">
       <div className="form-group">
        ...
        <button
          className="bg-teal-600 outline-none font-bold border text-white  py-3 pl-4 mt-2"
          type="submit"
          onClick={submitForm}
        >
          ADD USER
